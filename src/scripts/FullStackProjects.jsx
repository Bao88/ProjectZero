...
// images
import img0 from '../images/votenex.png';
...
class FullStackProjects extends React.Component {
    images = {
        0: ["votenex", "https://votenex.glitch.me/", "A Voting app where you can register and create new polls and vote in them. It is also possible to vote without registering. Technologies used: MongoDB, mongoose, NodeJS, Javascript, CSS3, HTML5, REST, Express. Platform: Glitch"],
    ...
    render(){
        return (
            <div className="projects">
                <h1 className="hTitle">Fullstack Projects</h1>
